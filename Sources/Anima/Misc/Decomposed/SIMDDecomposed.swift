...
extension matrix_double4x4 {
    ...
    struct DecomposedTransform {
        ...
        var rotation: simd_quatd = simd_quatd()
        
        /// The rotation of a transformation matrix (expressed as a euler angles).
        var eulerAngles: simd_double3 = .zero {
            didSet {
        ...
        var skew: simd_double3 = .zero
        
        /// The perspective of a transformation matrix (e.g. .m34).
        var perspective: simd_double4 = .zero
        ...
        func recomposed() -> matrix_double4x4 {
...
extension matrix_float4x4 {
    ...
    struct DecomposedTransform {
        ...
        var eulerAngles: simd_float3 = .zero {
            didSet {
        ...
        /// The shearing of a transformation matrix.
        var skew: simd_float3 = .zero
        
        /// The perspective of a transformation matrix (e.g. .m34).
        var perspective: simd_float4 = .zero
        ...
        func recomposed() -> matrix_float4x4 {
